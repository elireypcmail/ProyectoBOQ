...
export default function CreateServiceModal({ onSave, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const created = await onSave(newService)
    
    if (selectedFiles.length > 0 && (created?.data?.id || created?.id)) {
        const serviceId = created?.data?.id ?? created?.id
      ...
      <div className="modalService-content">
        ...
        <div className="modalService-header">
          <div className="header-title">
            ...
            <p>Complete los detalles para publicar un servicio en el catálogo.</p>
          </div>
          ...
          <form id="serviceForm" onSubmit={handleSubmit} className="form-content">
              ...
              <div className="form-grid">
                <div className="form-group full-width">
                    ...
                    <input 
                      ...
                      required 
                      placeholder="Ej: Diagnóstico Completo de Motor" 
                    />
                </div>
                <div className="form-group full-width">
                    ...
                    <input 
                      ...
                      required 
                      maxLength={120}
                      placeholder="Resumen breve (máx 120 caracteres)" 
                    />
                </div>
                <div className="form-group full-width">
                ...
                <div className="form-group">
                    ...
                    <datalist id="category-options">
                        ...
                        <option value="Reparación Correctiva"/>
                        <option value="Diagnóstico"/>
                        <option value="Estética / Detailing"/>
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                    ...
                    <input 
                      ...
                      onChange={e => handleInputChange("vehicle_trim", e.target.value)} 
                      placeholder="Ej: XLE Hybrid" 
                    />
                </div>

                {/* BOTÓN GLOBAL PARA AGREGAR VEHÍCULO */}
                <div className="form-group full-width">
                  <button
                    type="button"
                    className="button_cars_model"
                    onClick={() => {
                      ...
                      const vehicleString = `${vehicle_make || "-"} ${vehicle_model || "-"} ${vehicle_year || "-"} ${vehicle_trim || "-"}`.trim()

                      setFormData(prev => ({
                        ...prev,
                        compatible_vehicles: [...prev.compatible_vehicles, vehicleString],
                        vehicle_make: "",
                        vehicle_model: "",
                        vehicle_year: "",
                        vehicle_trim: ""
                ...
                <div className="form-group full-width">
                  <div className="models-list">
                    {formData.compatible_vehicles.map((model, idx) => (
                      <span key={idx} className="model-item">
                        {model} <IoClose size={14} style={{cursor:'pointer'}} onClick={() => {
                          setFormData(prev => ({
                            ...prev,
            ...
            <section className="form-section">
              ...
              <div className="form-grid">
                 ...
                 <ToggleField 
                  field="is_custom" 
                  label="¿Es un servicio personalizado?" 
                  formData={formData}
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                    ...
                    <input 
                        ...
                        placeholder="Ej: 6 Meses o 5000km" 
                    />
                </div>
              </div>
            </section>
            ...
            <section className="form-section">
                ...
                <div className="upload-area" onClick={() => document.getElementById("fileUploadService").click()}>
                    <MdOutlineCloudUpload size={48} color="#94a3b8" />
                    <p style={{margin: '10px 0 0', fontWeight: 500}}>Clic para subir imágenes o videos</p>
                    <p style={{fontSize: '0.8rem', color: '#94a3b8', margin: 0}}>Soporta PNG, JPG, MP4 (Máx 10MB)</p>
                    <input id="fileUploadService" type="file" multiple accept="image/*,video/*" hidden onChange={handleFileChange} />
                </div>
        ...
        <div className="modalService-footer">
          ...
          <button type="submit" form="serviceForm" className="btn-primary">Crear Servicio</button>
        </div>
