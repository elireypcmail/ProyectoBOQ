...
export const ProductsProvider = ({ children }) => {
  ...
  const getAllProducts = async () => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error fetching products"]]);
    }
  };
  ...
  const createNewProduct = async (newProduct) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error creating product"]]);
  ...
  const editProduct = async (id, product) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error editing product"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const deleteProductById = async (id) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error deleting product"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const getAllCategories = async () => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error fetching categories"]]);
    }
  };
  ...
  const createNewCategory = async (newCategory) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error creating category"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const editCategory = async (id, category) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error editing category"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const deleteCategoryById = async (id) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error deleting category"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const getAllBrands = async () => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error fetching brands"]]);
    }
  };
  ...
  const createNewBrand = async (newBrand) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error creating brand"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const editBrand = async (id, brand) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error editing brand"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const deleteBrandById = async (id) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error deleting brand"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const getAllLotes = async () => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error fetching lotes"]]);
    }
  };
  ...
  const createNewLote = async (newLote) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error creating lote"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const editLote = async (id, lote) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error editing lote"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const deleteLoteById = async (id) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error deleting lote"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const getAllInventory = async () => {
    try {
      const res = await ProductsAPI.getAllInventory();
      setInventory(res.data?.data || []);
    } catch (error) {
      setErrors(prev => [...prev, error.response?.data || ["Error fetching inventory"]]);
    }
  };
  ...
  const createNewInventory = async (newInv) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error creating inventory"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const editInventory = async (id, inv) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error editing inventory"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const deleteInventoryById = async (id) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error deleting inventory"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const getAllDeposits = async () => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error fetching deposits"]]);
    }
  };
  ...
  const createNewDeposit = async (newDep) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error creating deposit"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const editDeposit = async (id, dep) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error editing deposit"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const deleteDepositById = async (id) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error deleting deposit"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const getAllKardexG = async () => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error fetching kardex general"]]);
    }
  };
  ...
  const createNewKardexG = async (newKardex) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error creating kardex general"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
  ...
  const getAllKardexDep = async () => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error fetching kardex deposito"]]);
    }
  };
  ...
  const createNewKardexDep = async (newKardex) => {
    try {
      ...
      setErrors(prev => [...prev, error.response?.data || ["Error creating kardex deposito"]]);
      return { status: false, error: error.response?.data || error.message };
    }
  };
